      ...
      {songs.map((item, idx) => {
        ...
        return (
          <div
            ...
            className="h-fit max-340:w-[60vw] max-560:w-[70vw] max-560:ml-4 max-340:ml-2 max-340:mt-2 sm:w-[35vw] lg:w-[40vw] sm:ml-5 xl:w-[190px] bg-[#252525] group hover:bg-[#4b4747] transition-all duration-200 rounded-lg cursor-pointer "
          >
            ...
            <div className="px-3 pt-2">
              <h1 className="xl:text-xl text-[55px] truncate max-340:text-[22px] max-560:text-[25px]">
                {meta ? meta.title : item.folder}
              </h1>
              <p className="xl:text-[12px] text-[33px] max-340:text-[18px] max-560:text-[22px] text-gray-400 truncate">
